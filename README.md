...
<!-- 1. Explain the difference between `Relational Databases` and `SQL`. -->
    ...
    Relational databases are a database (systematic collection of information, or data typically in column and row forms/tables) that has one or more table that it has some relationship or ability to interact with, with the use of a foreign key.
    SQL is the standard language for dealing with Relational Databases. They can; create a table and insert data into it, query and filter data, modify and update data, delete data or tables.

<!-- 2. Why do tables need a `primary key`? -->

    Tables need a primary key because there needs to be some kind of unique identifier in RD's to quickly parse data.
